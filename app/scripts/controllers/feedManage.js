...
angular.module('myApp.controllers.feedManage', ['myApp.utils', 'fr.feedManager'])
    ...
    .controller('HearthCtrl', ['$scope', 'feedManager', '$location', '$dialog', 'disposeOnLogout',
        'feedScopeUtils', 'syncData',
        function ($scope, feedManager, $location, $dialog, disposeOnLogout, feedScopeUtils, syncData) {
...
//                }
    ...
    ['$scope', '$timeout', 'feedManager', '$location',
        ...
        function ($scope, $timeout, feedManager, $location, disposeOnLogout, feedScopeUtils, syncData) {
            var pid = $scope.auth_min.provider;
            var uid = $scope.auth_min.user;
            var feedMgr = $scope.feedManager = new feedManager(pid, uid, disposeOnLogout);
            feedScopeUtils($scope, feedMgr);
